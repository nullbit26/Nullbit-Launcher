...
- Fixed `BranchMineJob` constants — `BRANCH_LENGTH`, `MAX_BRANCHES`, `ORE_SCAN_RADIUS`, `TORCH_INTERVAL` now read from `process.env`
...
## v3.0.0
- Initial release — basic launcher with config, launch/stop, GitHub updates
